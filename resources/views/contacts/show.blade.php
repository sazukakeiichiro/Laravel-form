                ...
                <div class="container px-5  mx-auto">
                    ...
                    <!-- ホームページ -->
                        ...
                        <!-- ボタン -->
                            ...
                            <form id="delete_{{ $contact->id }}" class="mt-4" method="post" action="{{ route('contacts.destroy', ['id'=> $contact->id ]) }}"
                                @csrf
                            <div class="p-2 w-full">
                            <button href="#" data-id="{{ $contact->id }}" onclick="deletePost(this)" class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">削除する</button>
                            </div>
                            </form>
